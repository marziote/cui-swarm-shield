...
def update_master(l_km_exp, z_in, n_in, v_in, r_in, off_in, k_in, days, t_chg, c_uuv, c_batt, v_spr, t_c2, t_eval, t_tgt):
    ...
    fig_90.update_layout(title="<b>ZONA SEGURA (>90%)</b>", scene=dict(camera=CAM_3D, xaxis_title="Offset", yaxis_title="Flota (N)", zaxis_title="Distancia Lateral (m)"), margin=dict(l=0, r=0, t=30, b=0))
    ...
    fig_10.update_layout(title="<b>ZONA DE ADVERTENCIA (>10%)</b>", scene=dict(camera=CAM_3D, xaxis_title="Offset", yaxis_title="Flota (N)", zaxis_title="Distancia Lateral (m)"), margin=dict(l=0, r=0, t=30, b=0))
    ...
    fig_map.add_shape(type="line", x0=0, x1=100, y0=-off_in, y1=-off_in, line=dict(color="white", width=1, dash="dash"))
    fig_map.update_layout(title=f"<b>PROBABILIDAD (R_eff={r_eff:.1f}m)</b>", yaxis_title="Distancia Lateral (m)", margin=dict(l=45, r=10, t=30, b=10), plot_bgcolor='#111', xaxis=dict(showticklabels=False))
    ...
    fig_rng.update_layout(title="<b>TIEMPO CIEGO vs ALCANCE</b>", xaxis_title="Alcance del Sensor (m)", yaxis_title="Tiempo Ciego (min)", margin=dict(l=45, r=10, t=30, b=35), showlegend=False)
