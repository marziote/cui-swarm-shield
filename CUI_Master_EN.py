...
# ==============================================================================
# 1A. KERNEL MATEMATICO LOGISTICA
# ==============================================================================
class CUI_Kernel:
    def __init__(self):
        self.D_std = 8900.0      
...
# ==============================================================================
# 1B. KERNEL MATEMATICO FISICA
# ==============================================================================
class CUI_Physics_Kernel:
    def __init__(self): self.FTO = 1.05
    ...
    html.Div(style={'flex': '0 0 auto', 'padding': '5px'}, children=[
        ...
        html.Div(style={**row_style, 'backgroundColor': '#ecf0f1', 'border': '1px solid #bdc3c7'}, children=[
            ...
            html.Div(style=sld_style, children=[
                html.Div(style={'display':'flex', 'width': '100%', 'justifyContent': 'space-between', 'marginBottom':'2px'}, children=[html.Div(id='lbl-t-c2', style={'fontWeight': 'bold', 'color': '#d35400', 'fontSize': '10px'}), html.Div(id='lbl-t-eval', style={'fontWeight': 'bold', 'color': '#d35400', 'fontSize': '10px'})]),
...
def update_master(l_km_exp, z_in, n_in, v_in, r_in, off_in, k_in, days, t_chg, c_uuv, c_batt, v_spr, t_c2, t_eval, t_tgt):
    ...
    Z_plot, C_surf = np.zeros_like(X_n), np.zeros_like(X_n)
    for i in range(X_n.shape[0]):
        for j in range(X_n.shape[1]):
            ...
            C_surf[i,j] = K_log.calculate_system_complete(l_km, X_n[i,j], days, c_uuv, c_batt, t_chg)[0]
